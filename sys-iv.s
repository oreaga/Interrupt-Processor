...
tlbumiss:	addi	r1, r4, 0	# save PSR (mostly for the ASID)
        ...
        sw r3, r0, u_r3 # Save the contents of r3 in case of tlb_kmiss
        sw r7, r0, u_r7 # Save EPC value in case of tlb_kmiss
		lw	r2, r3, 0	# get the PTE
        lw r7, r0 , u_r7 # Restore EPC (doesn't matter if lw succeeds)
		tlbw	r2, r3
...
tlbkmiss:	lw r2, r3, 0 # get the PTE from root table
        tlbw r2, r3 # Write user page table into tlb
        lw r3, r0, u_r3 # Load umiss PTE location
        rfe r7
